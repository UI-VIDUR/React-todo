  ...
  return (
    <Listbox value={value} onChange={onChange}>
      ...
      <div className="relative">
        <ListboxButton className="grid w-full min-w-40 cursor-default grid-cols-1 rounded-md bg-white py-1.5 pr-2 pl-3 text-left text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-600 sm:text-sm/6">
          <span className="col-start-1 row-start-1 flex items-center gap-3 pr-6">
            <span className="block truncate">{value.label ? value.label : "Filter By"}</span>
          </span>
          <ChevronUpDownIcon
            aria-hidden="true"
